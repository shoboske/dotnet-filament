...
/// <summary>Shows a Customer's Orders inline on their Edit page (issue #9) — scoped by the
/// existing Order.CustomerId FK, the same navigation OrderResource.Table() already joins
/// through (see its .Include(o => o.Customer)).</summary>
